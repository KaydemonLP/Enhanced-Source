...
IMPLEMENT_SERVERCLASS_ST( CSDKMachineGun, DT_SDKMachineGun )
END_SEND_TABLE()
...
//
//-----------------------------------------------------------------------------
void CSDKMachineGun::PrimaryAttack( void )
{
	...
	// MUST call sound before removing a round from the clip of a CSDKMachineGun
...
//-----------------------------------------------------------------------------
int CSDKMachineGun::WeaponRangeAttack1Condition( float flDot, float flDist )
{
	if ( m_iClip1 <=0 )
	{
...
IMPLEMENT_SERVERCLASS_ST( CSDKSelectFireMachineGun, DT_SDKSelectFireMachineGun )
END_SEND_TABLE()

//=========================================================
//	>> CSDKSelectFireMachineGun
//=========================================================
BEGIN_DATADESC( CSDKSelectFireMachineGun )
...
float CSDKSelectFireMachineGun::GetBurstCycleRate( void )
{
...
float CSDKSelectFireMachineGun::GetFireRate( void )
{
	switch( m_iFireMode )
	{
...
bool CSDKSelectFireMachineGun::Deploy( void )
{
...
//
//-----------------------------------------------------------------------------
void CSDKSelectFireMachineGun::PrimaryAttack( void )
{
	if (m_bFireOnEmpty)
	{
		return;
	...
	case FIREMODE_3RNDBURST:
		...
		BurstThink();
		SetThink( &CSDKSelectFireMachineGun::BurstThink );
...
//
//-----------------------------------------------------------------------------
void CSDKSelectFireMachineGun::SecondaryAttack( void )
{
	// change fire modes.
...
//
//-----------------------------------------------------------------------------
void CSDKSelectFireMachineGun::BurstThink( void )
{
	CSDKMachineGun::PrimaryAttack();
...
//
//-----------------------------------------------------------------------------
void CSDKSelectFireMachineGun::WeaponSound( WeaponSound_t shoot_type, float soundtime /*= 0.0f*/ )
{
...
//-----------------------------------------------------------------------------
int CSDKSelectFireMachineGun::WeaponRangeAttack1Condition( float flDot, float flDist )
{
	if (m_iClip1 <=0)
	{
		return COND_NO_PRIMARY_AMMO;
...
//-----------------------------------------------------------------------------
int CSDKSelectFireMachineGun::WeaponRangeAttack2Condition( float flDot, float flDist )
{
...
// Purpose: Constructor
//-----------------------------------------------------------------------------
CSDKSelectFireMachineGun::CSDKSelectFireMachineGun( void )
{
	m_fMinRange1	= 65;
	m_fMinRange2	= 65;
	m_fMaxRange1	= 1024;
