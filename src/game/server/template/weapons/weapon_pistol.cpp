...
class CWeaponPistol : public CBaseSDKCombatWeapon
{
	DECLARE_DATADESC();

public:
	DECLARE_CLASS( CWeaponPistol, CBaseSDKCombatWeapon );
...
CWeaponPistol::CWeaponPistol( void )
{
	...
	// We use this incase we want players to hit +use to pick it up.
	SetTouchPickup( true );
}
