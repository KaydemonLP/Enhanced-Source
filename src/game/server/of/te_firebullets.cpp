...
public:
	...
	CNetworkVar( int, m_iBulletsPerShot );
...
IMPLEMENT_SERVERCLASS_ST_NOBASE(CTEFireBullets, DT_TEFireBullets)
	...
	SendPropInt( SENDINFO( m_iBulletsPerShot ) ),
...
// Singleton
// TODO?: Rename this to something else??? What does this even do? - Kay
	...
	float flRange )
{
	...
	g_TEFireBullets.m_iDamage = iDamage;
	g_TEFireBullets.m_iBulletsPerShot = iBulletsPerShot;
