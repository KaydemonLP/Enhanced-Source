...
// DON'T use DMG_CRUSH when damaging entities unless it's the result of a physics collision. You probably want DMG_CLUB instead.
	...
	DMG_BLAST,					// explosive blast damage
	...
	DMG_NEVERGIB,				// with this, no damage type will be able to gib victims upon death
	DMG_ALWAYSGIB,				// with this, any damage type can be made to gib victims upon death.
	DMG_DROWN,					// Drowning
	...
	DMG_REMOVENORAGDOLL,		// with this, no ragdoll will be created, and the target will be quietly removed.
