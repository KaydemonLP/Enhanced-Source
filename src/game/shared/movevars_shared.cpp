...
#else
#define DEFAULT_GRAVITY_STRING	"900"
#endif
...
ConVar	sv_maxspeed		( "sv_maxspeed", "720", FCVAR_NOTIFY | FCVAR_REPLICATED );
...
#ifdef INFESTED_DLL
ConVar	sv_stepsize		( "sv_stepsize","24", FCVAR_NOTIFY | FCVAR_REPLICATED );
#else
...
ConVar	sv_backspeed	( "sv_backspeed", "0.6", FCVAR_REPLICATED, "How much to slow down backwards motion" );
...
#ifdef OFFSHORE_DLL
ConVar sv_maxslopeangle( "sv_maxslopeangle", "0.7", FCVAR_CHEAT | FCVAR_NOTIFY | FCVAR_REPLICATED );
#endif