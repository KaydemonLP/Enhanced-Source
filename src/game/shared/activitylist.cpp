...
void ActivityList_RegisterSharedActivities(void)
{
	...
	REGISTER_SHARED_ACTIVITY(ACT_COVER);					// FIXME: obsolete? redundant with REGISTER_SHARED_ACTIVITY( ACT_COVER_LOW?
	REGISTER_SHARED_ACTIVITY(ACT_COVER_MED);				// FIXME: unsupported?
	REGISTER_SHARED_ACTIVITY(ACT_COVER_LOW);				// FIXME: rename REGISTER_SHARED_ACTIVITY( ACT_IDLE_CROUCH?
	...
	REGISTER_SHARED_ACTIVITY(ACT_BARNACLE_HIT);		// barnacle tongue hits a monster
	REGISTER_SHARED_ACTIVITY(ACT_BARNACLE_PULL);		// barnacle is lifting the monster ( loop )
	REGISTER_SHARED_ACTIVITY(ACT_BARNACLE_CHOMP);		// barnacle latches on to the monster
	REGISTER_SHARED_ACTIVITY(ACT_BARNACLE_CHEW);		// barnacle is holding the monster in its mouth ( loop )
	...
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_L);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_R);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_RL);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_L_RECOIL1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_L_RECOIL2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_L_RECOIL3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_R_RECOIL1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_R_RECOIL2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_R_RECOIL3);
	...
	REGISTER_SHARED_ACTIVITY(ACT_PHYSCANNON_ANIMATE_PRE);	// An activity to be played by an object being picked up with the physcannon ); before playing the REGISTER_SHARED_ACTIVITY( ACT_PHYSCANNON_ANIMATE
	REGISTER_SHARED_ACTIVITY(ACT_PHYSCANNON_ANIMATE_POST);// An activity to be played by an object being picked up with the physcannon ); after playing the REGISTER_SHARED_ACTIVITY( ACT_PHYSCANNON_ANIMATE
	...
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_PRIMARY);		// RUN ); WALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_PRIMARY_DEPLOYED);
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_CROUCH_PRIMARY);		// CROUCHWALK
	...
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_STAND_PRIMARY);		// RUN ); WALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_STAND_PRIMARY_LOOP);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_STAND_PRIMARY_END);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_CROUCH_PRIMARY);		// CROUCHWALK
	...
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_GRENADE_PRIMARY);		// RUN ); WALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_CROUCH_GRENADE_PRIMARY);		// CROUCHWALK
	...
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_SECONDARY);		// RUN ); WALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_CROUCH_SECONDARY);		// CROUCHWALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_SWIM_SECONDARY);
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_AIRWALK_SECONDARY);

	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_STAND_SECONDARY);		// RUN ); WALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_STAND_SECONDARY_LOOP);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_STAND_SECONDARY_END);
	REGISTER_SHARED_ACTIVITY(ACT_MP_RELOAD_CROUCH_SECONDARY);		// CROUCHWALK
	...
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_GRENADE_SECONDARY);		// RUN ); WALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_CROUCH_GRENADE_SECONDARY);		// CROUCHWALK
	...
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_MELEE);		// RUN ); WALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_MELEE_SECONDARY);
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_CROUCH_MELEE);		// CROUCHWALK
	...
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_GRENADE_MELEE);		// RUN ); WALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_CROUCH_GRENADE_MELEE);		// CROUCHWALK
	...
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_ITEM1);		// RUN ); WALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_ITEM1_SECONDARY);
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_CROUCH_ITEM1);		// CROUCHWALK
	...
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_ITEM2);		// RUN ); WALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_ITEM2_SECONDARY);
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_CROUCH_ITEM2);		// CROUCHWALK
	...
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_BUILDING);		// RUN ); WALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_CROUCH_BUILDING);		// CROUCHWALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_SWIM_BUILDING);
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_AIRWALK_BUILDING);

	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_STAND_GRENADE_BUILDING);		// RUN ); WALK
	REGISTER_SHARED_ACTIVITY(ACT_MP_ATTACK_CROUCH_GRENADE_BUILDING);		// CROUCHWALK
